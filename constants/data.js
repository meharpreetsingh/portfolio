const userData = {
  githubUsername: 'meharpreetsingh',
  name: 'Meharpreet Singh',
  designation: 'Full-Stack Developer',
  avatarUrl: '/avatar.jpg',
  email: 'meharpreet0000@gmail.com',
  phone: '+91 8360350054',
  ...
  about: {
    ...
    description: [
      ...
      `But now, I'm a legend. I've been coding in React, Node.js, Express, MongoDB, MySQL, Bootstrap, Tailwind, C, C++, Assembly, Logo and YouDontKnowShit programming language, etc to name a few. Although I barely know the syntax (Psst, Stack overflow!), I consider myself a Ninja developer. I'm laughing right now.`,
    ],
  ...
  socialLinks: {
    instagram: 'https://instagram.com/mehar.graphix',
